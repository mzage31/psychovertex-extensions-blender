...
class UvToolsMoveUVMapDownOperator(Operator):
...
class UvToolsMoveUVMapUpOperator(Operator):
...
class UvToolsRenameOperator(Operator):
...
class UvToolsSelectOperator(Operator):
...
class UvToolsAddOperator(Operator):
...
class UvToolsRemoveOperator(Operator):
...
class UvToolsProperties(PropertyGroup):
...
def register():
    bpy.types.Scene.uvtoolsProperties = PointerProperty(type=UvToolsProperties)
